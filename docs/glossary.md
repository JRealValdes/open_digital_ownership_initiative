...
Terms used by the Digital Ownership Framework. Prefer these definitions
in issues, RFCs, and pull requests.
...
| **Offline Ownership** | Ownership mode represented by a unique physical ownership token, usable without ongoing store connectivity for ordinary play. |
| **Owner** | The person or legal entity that holds ownership of a game copy. |
| **Ownership** | Durable right to possess, use, preserve, transfer, and lend a game copy under this framework. |
| **Ownership event** | An action that changes ownership state: purchase, transfer, lending start/end, mode conversion, recovery. |
| **Ownership mode** | Whether a copy is currently in Digital or Offline Ownership. |
